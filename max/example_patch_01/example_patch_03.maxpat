...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 722.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 55.0, 779.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 230.0, 504.0, 45.0, 22.0 ],
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.625, 504.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 504.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 504.0, 59.0, 22.0 ],
					"text" : "prepend ["
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 532.0, 55.0, 22.0 ],
					"text" : "append ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 866.5, 565.5, 97.0, 62.0 ],
					"text" : "dict.pack synthType: fm harmonicity: modIndex:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 737.761904761904816, 565.5, 97.0, 62.0 ],
					"text" : "dict.pack synthType: am modFreq: modDepth:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 593.583343333333232, 579.5, 103.0, 35.0 ],
					"text" : "dict.pack synthType: sine"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 711.428571428571445, 488.0, 98.0, 22.0 ],
					"text" : "route sine am fm"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 737.761904761904816, 707.0, 51.0, 22.0 ],
					"text" : "s metas"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.0, 535.0, 49.0, 22.0 ],
					"text" : "r metas"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 55.0, 597.0, 86.0, 22.0 ],
					"text" : "dict.pack note:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 779.0, 489.0, 217.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 55.0, 565.5, 320.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 57.5, 419.0, 484.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
					"text" : "bach.playkeys cents velocity duration [slot 1] [slot 10] [slot 3] [slot 4] [slot 6] [slot 7] @out t"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 24.0, 99.0, 827.0, 252.833327999999995 ],
					"pitcheditrange" : [ "null" ],
					"ruler" : 2,
					"showplayhead" : 1,
					"stafflines" : [ 5 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 299.5, 455.0, 720.928571428571445, 455.0 ],
					"source" : [ "obj-10", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 415.75, 519.0, 825.261904761904816, 519.0 ],
					"source" : [ "obj-10", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 357.625, 502.0, 357.625, 516.0, 786.261904761904816, 516.0 ],
					"source" : [ "obj-10", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 532.0, 517.0, 954.0, 517.0 ],
					"source" : [ "obj-10", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 473.875, 514.0, 915.0, 514.0 ],
					"source" : [ "obj-10", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 241.375, 473.0, 291.5, 473.0 ],
					"source" : [ "obj-10", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 67.0, 478.0, 13.5, 478.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 183.25, 488.0, 239.5, 488.0 ],
					"source" : [ "obj-10", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 64.5, 689.0, 101.5, 689.0 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 64.5, 757.0, 276.5, 757.0 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 726.071428571428555, 369.0, 67.0, 369.0 ],
					"order" : 1,
					"source" : [ "obj-2", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 799.928571428571445, 521.0, 719.0, 521.0, 719.0, 543.0, 603.083343333333232, 543.0 ],
					"source" : [ "obj-33", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-76", 0 ],
					"midpoints" : [ 720.928571428571445, 546.0, 603.083343333333232, 546.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 773.595238095238074, 542.0, 876.0, 542.0 ],
					"source" : [ "obj-33", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 603.083343333333232, 662.0, 747.261904761904816, 662.0 ],
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 876.0, 666.0, 747.261904761904816, 666.0 ],
					"source" : [ "obj-83", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 13.5, 547.0, 64.5, 547.0 ],
					"source" : [ "obj-88", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 239.5, 551.0, 215.0, 551.0 ],
					"source" : [ "obj-94", 0 ]
				}
